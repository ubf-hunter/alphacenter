        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
              {/* App Store (iOS - ouvre modal instructions) */}
              <button
                onClick={() => setShowIOSModal(true)}
                className="inline-flex items-center gap-3 px-6 py-3.5 bg-white rounded-xl hover:bg-gray-100 transition-colors group cursor-pointer"
              >
                <svg
                  className="w-8 h-8"
                  viewBox="0 0 24 24"
