        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <Badge variant="apricot" className="mb-6">
              <TabletSmartphone size={16} className="inline mr-1" /> Application mobile
            </Badge>

            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Révise partout avec l'app{' '}
              <span className="text-orange">Alpha</span>
            </h2>

            <p className="text-lg text-gray-300 mb-8">
              Notre application mobile te permet de réviser efficacement où que tu sois.
              QCM, cours, annales corrigées... tout est accessible même sans internet.
            </p>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white font-semibold text-sm">2,458 QCM</div>
                            <div className="text-white/70 text-xs">répondus cette semaine</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white font-semibold text-sm">Top 5%</div>
                            <div className="text-white/70 text-xs">des utilisateurs</div>
                          </div>
                        </div>
                      </div>
                    </div>
