...
const featureIcons = [BookOpen, WifiOff, CheckCircle, TrendingUp];
const featureKeys = ['qcm', 'offline', 'corrections', 'progress'];
...
export default function AppPromo() {
  ...
  const features = featureKeys.map((key, i) => ({
    icon: featureIcons[i],
    title: t(`appPromo.features.${key}.title`),
    description: t(`appPromo.features.${key}.description`),
  }));
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <Badge variant="apricot" className="mb-6">
              <TabletSmartphone size={16} className="inline mr-1" /> {t('appPromo.badge')}
            </Badge>

            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              {t('appPromo.title')}{' '}
              <span className="text-orange font-cursive italic">{t('appPromo.titleHighlight')}</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs text-gray-500">{t('appPromo.downloadOn')}</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs text-gray-500">{t('appPromo.availableOn')}</div>
                  <div className="text-sm font-semibold text-gray-900">
                    Google Play
                  </div>
                </div>
                ...
                <div className="absolute top-2 left-2 right-2 bottom-2 bg-gradient-to-br from-orange to-orange-600 rounded-[2.5rem] overflow-hidden">
                  ...
                  <div className="p-6 pt-12 h-full flex flex-col">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-white/70 text-sm">{t('appPromo.phone.tagline')}</p>
                    </div>
