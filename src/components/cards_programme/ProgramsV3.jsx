...
export default function ProgramsV3() {
  ...
  const programs = programKeys.map((p) => ({
    ...p,
    title: t(`programsAlt.v3.${p.key}.title`),
    subtitle: t(`programsAlt.v3.${p.key}.subtitle`),
    description: t(`programsAlt.v3.${p.key}.description`),
    cta: t(`programsAlt.v3.${p.key}.cta`),
  }));
